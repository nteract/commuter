// flow-typed signature: 1e4a64f4cc1270594c421b164c025b95
// flow-typed version: <<STUB>>/aws-sdk_v^2.41.0/flow_v0.44.2
...
declare module "aws-sdk/clients/s3" {
  ...
  declare type $APIMethod<Params, Result> = (
    params: Params,
    cb?: $Callback<Result>
  ) => Request<Result>;
  ...
  declare class S3$20060301 {
    // Only defining as much as is needed for our use
    deleteObject: $APIMethod<
      S3$20060301$DeleteObjectRequest,
      S3$20060301$DeleteObjectOutput
    >,
    deleteObjects: $APIMethod<
      S3$20060301$DeleteObjectsRequest,
      S3$20060301$DeleteObjectsOutput
    >,
    getObject: $APIMethod<
      S3$20060301$GetObjectRequest,
      S3$20060301$GetObjectOutput
    >,
    listObjectsV2: $APIMethod<
      S3$20060301$ListObjectsV2Request,
      S3$20060301$ListObjectsV2Output
    >,
    upload: $APIMethod<any, any>
  }
  ...
  declare module.exports: typeof S3;
}
