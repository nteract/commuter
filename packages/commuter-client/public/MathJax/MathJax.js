...
if (document.getElementById && document.childNodes && document.createElement) {
  if (!(window.MathJax && MathJax.Hub)) {
      ...
      loadDomain: function(c, e) {
        ...
        if (a) {
          if (!a.isLoaded) {
            ...
            if (b) {
              return MathJax.Callback
                .Queue(b, ["loadDomain", this, c])
                .Push(e || {});
            }
          }
      ...
      Clear: function(b, a) {
        ...
        if (this.current === b) {
          ...
          if (this.text) {
            ...
            if (this.status) {
              window.status = this.current == null
                ? ""
                : this.log[this.current].text;
            }
          }
        }
    ...
    (function(o) {
      ...
      var b = (document.documentElement || document)
        ...
        if ((b[q].src || "").match(f)) {
          ...
          w.root = b[q].src
            ...
            .replace(
              ...
              "$1" + h.version.split(/\./).slice(0, 2).join(".") + "-$2"
            );
          ...
          Firefox: function(j) {
            if (
              ...
              if (m) {
                ...
                var i = (navigator.buildID || navigator.productSub || "0")
                  .substr(0, 8);
                if (i >= "20111220") {
                  j.version = "9.0";
                } else {
