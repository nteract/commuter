...
(function(h, d, e, a) {
  ...
  var c = document.getElementsByTagName("base").length === 0
    ? ""
  ...
  a.Augment({
    ...
    Config: function() {
      ...
      var m = d.config.menuSettings, l = this.config, k = m.font;
      if (m.scale) {
        l.scale = m.scale;
      }
      if (k && k !== "Auto") {
    ...
    preTranslate: function(q) {
      ...
      for (B = 0; B < x; B++) {
        ...
        y = Math.max(
          0,
          (s.previousSibling.firstChild.offsetWidth - 2) /
            this.config.scale *
            100
        );
        if (D === 0 || D === "NaN") {
    ...
    length2em: function(q, l, o) {
      ...
      var k = parseFloat(n[1] || "1") * 1000, p = n[2];
      if (o == null) {
        o = 1000;
      }
      if (l == null) {
    ...
    getBorders: function(o) {
      var m = { top: 0, right: 0, bottom: 0, left: 0 }, l = false;
      for (var p in m) {
    ...
    createChar: function(s, q, n) {
      var r = "", p = { fonts: [q[1]], noRemap: true };
    ...
    extendDelimiterV: function(r, A, m, o, n) {
      ...
      if (A > q) {
        ...
        var p = m.mid ? 2 : 1, v = (A - q) / p, B = (v + 100) / (l.h + l.d);
        while (p-- > 0) {
          var t = a.Element("g", {
            transform: "translate(" +
              l.y +
    ...
    extendDelimiterH: function(t, o, m, q, n) {
      ...
      t.Add(p, -p.l, 0);
      var B = p.r - p.l + (C.r - C.l), z = p.r - p.l;
      if (m.mid) {
      ...
      if (o > B) {
        var y = this.createChar(q, m.rep, n), l = m.fuzz || 0;
        var r = m.mid ? 2 : 1, v = (o - B) / r, D = (v + l) / (y.r - y.l);
        while (r-- > 0) {
          var u = a.Element("g", {
            transform: "translate(" +
              (z - l / 2 - D * y.l + y.x) +
    ...
    Add: function(n, t, s, k, r) {
      ...
      if (n.element) {
        if (n.removeable && n.element.childNodes.length === 1 && n.n === 1) {
          var l = n.element.firstChild, p = l.nodeName.toLowerCase();
          if (p === "use" || p === "rect") {
            n.element = l;
            n.scale = n.childScale;
            var q = n.childX, o = n.childY;
            n.x += q;
            n.y += o;
            n.h -= o;
            n.d += o;
  ...
  i.GLYPH = i.Subclass(
    {
      ...
      Init: function(u, n, y, z, A, v, m, o) {
        var q, B = a.config.blacker, x = i.GLYPH;
  ...
  d.Register.StartupHook("mml Jax Ready", function() {
    ...
    g.mo.Augment({
      toSVG: function(l, k) {
        ...
        for (var s = 0, o = this.data.length; s < o; s++) {
          if (this.data[s]) {
            var A = this.data[s].toSVG(r, p, this.remap, n), v = t.w;
            if (v === 0 && -A.l > 10 * A.w) {
              v += -A.l;
            }
            t.Add(A, v, 0, true);
      ...
      SVGcanStretch: function(o) {
        ...
        if (
          ...
          var n = l.data[l.over], k = l.data[l.under];
      ...
      SVGstretchV: function(p, q) {
        ...
        var o = a.TeX.axis_height * m.scale, k = this.SVGgetMu(m), n;
        if (l.symmetric) {
      ...
      SVGstretchH: function(l) {
        var n = this.svg || this.toSVG(), k = this.SVGgetMu(n);
    ...
    g.mn.Augment({
      ...
      toSVG: function() {
        if (a.config.mtextFontInherit || this.Parent().type === "merror") {
          this.SVGgetStyles();
          var k = this.SVG(), n = this.SVGgetScale(k);
          this.SVGhandleSpace(k);
          var l = this.SVGgetVariant(), m = { direction: this.Get("dir") };
          if (l.bold) {
            m["font-weight"] = "bold";
          }
          if (l.italic) {
    ...
    g.merror.Augment({
      toSVG: function(n, k) {
        this.SVGgetStyles();
        var r = this.SVG(), p = a.length2em(this.styles.fontSize || 1) / 1000;
    ...
    g.mspace.Augment({
      toSVG: function() {
        ...
        var l = this.SVG();
        this.SVGgetScale(l);
        var n = this.mscale, k = this.SVGgetMu(l);
    ...
    g.mpadded.Augment({
      toSVG: function(n, k) {
        ...
        if (this.data[0] != null) {
          ...
          var o = this.SVGdataStretched(0, n, k), v = this.SVGgetMu(q);
    ...
    g.mfrac.Augment({
      toSVG: function() {
        this.SVGgetStyles();
        var y = this.SVG(), G = this.SVGgetScale(y);
        var m = i();
        m.scale = y.scale;
        this.SVGhandleSpace(m);
        var o = this.SVGchildSVG(0), n = this.SVGchildSVG(1);
        var k = this.getValues(
          "displaystyle",
          "linethickness",
          "numalign",
    ...
    g.msqrt.Augment({
      toSVG: function() {
        this.SVGgetStyles();
        var r = this.SVG(), n = this.SVGgetScale(r);
        this.SVGhandleSpace(r);
        var m = this.SVGchildSVG(0), s, o;
        var w = a.TeX.rule_thickness * n, l, k, v, u = 0;
    ...
    g.munderover.Augment({
      toSVG: function(F, C) {
        ...
        var E = this.SVG(), M = this.SVGgetScale(E);
        this.SVGhandleSpace(E);
        var p = [], K = [], u, J, G, n = -a.BIGDIMEN, I = n;
    ...
    g.msubsup.Augment({
      toSVG: function(I, B) {
        ...
        var l = (this.data[this.sup] || this.data[this.sub] || this)
          .SVGgetScale();
        var K = a.TeX.x_height * M, A = a.TeX.scriptspace * M;
        var k, n;
        ...
        var F = a.TeX.sup_drop * l, C = a.TeX.sub_drop * l;
        var y = m.h + (m.y || 0) - F, w = m.d - (m.y || 0) + C, L = 0, H;
        if (m.ic) {
          m.w -= m.ic;
          L = 1.3 * m.ic + 0.05;
        }
        ...
        J.subscriptshift = J.subscriptshift === ""
          ? 0
          : a.length2em(J.subscriptshift, G);
        J.superscriptshift = J.superscriptshift === ""
          ? 0
          : a.length2em(J.superscriptshift, G);
        var o = m.w + m.x;
        if (!k) {
          if (n) {
            w = Math.max(w, a.TeX.sub1 * M, n.h - 4 / 5 * K, J.subscriptshift);
            E.Add(n, o, -w);
          ...
          if (!n) {
            ...
            H =
              a.TeX[
                values.displaystyle
                  ? "sup1"
                  : values.texprimestyle ? "sup3" : "sup2"
              ];
    ...
    g.math.Augment({
      ...
      toSVG: function(z, n) {
        ...
        if (this.data[0]) {
          ...
          var s = Math.max(-u.l, 0), m = Math.max(u.r - u.w, 0);
          var o = u.element.style, y = a.TeX.x_height / a.ex;
    ...
    g.TeXAtom.Augment({
      toSVG: function(k, n) {
        ...
        this.SVGhandleSpace(l);
        if (this.data[0] != null) {
          var m = this.SVGdataStretched(0, k, n), o = 0;
