...
declare module "lodash" {
  ...
  declare class Lodash {
    ...
    defaultTo<T1: string | boolean | Object, T2>(value: T1, defaultArg: T2): T1,
    // NaN is a number instead of its own type, otherwise it would behave like null/void
    defaultTo<T1: number, T2>(value: T1, defaultArg: T2): T1 | T2,
    defaultTo<T1: void | null, T2>(value: T1, defaultArg: T2): T2,
